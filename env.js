...
const _clientEnv = {
  ...
  EXPO_PUBLIC_ANALYZE_VIDEO_CONVERSATION_ENDPOINT:process.env.EXPO_PUBLIC_ANALYZE_VIDEO_CONVERSATION_ENDPOINT,
  EXPO_PUBLIC_ANALYZE_IMAGE_CONVERSATION_ENDPOINT:process.env.EXPO_PUBLIC_ANALYZE_IMAGE_CONVERSATION_ENDPOINT,
