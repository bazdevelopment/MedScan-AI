...
const client = z.object({
  ...
  EXPO_PUBLIC_ANALYZE_IMAGE_ENDPOINT:z.string().optional(),
  EXPO_PUBLIC_ANALYZE_VIDEO_ENDPOINT:z.string().optional(),
  EXPO_PUBLIC_ANALYZE_IMAGE_CONVERSATION:z.string().optional(),
...
const _clientEnv = {
  ...
  EXPO_PUBLIC_ANALYZE_IMAGE_ENDPOINT:process.env.EXPO_PUBLIC_ANALYZE_IMAGE_ENDPOINT,
  EXPO_PUBLIC_ANALYZE_VIDEO_ENDPOINT:process.env.EXPO_PUBLIC_ANALYZE_VIDEO_ENDPOINT,
  EXPO_PUBLIC_ANALYZE_IMAGE_CONVERSATION:process.env.EXPO_PUBLIC_ANALYZE_IMAGE_CONVERSATION,
   EXPO_PUBLIC_CONTINUE_CONVERSATION_ENDPOINT:process.env. EXPO_PUBLIC_CONTINUE_CONVERSATION_ENDPOINT
